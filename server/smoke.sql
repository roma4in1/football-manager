...
-- seasons and clubs are league-scoped since 0003
INSERT INTO leagues (id, name, status) VALUES
  ('00000000-0000-0000-0000-0000000000b1', 'Smoke league', 'active');

INSERT INTO seasons (id, number, matchweek_count, transfer_week, league_id) VALUES
  ('00000000-0000-0000-0000-00000000000a', 1, 14, 7, '00000000-0000-0000-0000-0000000000b1');

INSERT INTO clubs (id, manager_id, name, league_id) VALUES
  ('00000000-0000-0000-0000-0000000000c1', '00000000-0000-0000-0000-000000000001', 'Alpha', '00000000-0000-0000-0000-0000000000b1'),
  ('00000000-0000-0000-0000-0000000000c2', '00000000-0000-0000-0000-000000000002', 'Beta', '00000000-0000-0000-0000-0000000000b1');
