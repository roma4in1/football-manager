...
const scenario: ScenarioDef = {
  ...
  bodies: [
    { id: 'short', team: 'home', pos: { x: 30, y: 20 }, attributes: { pace: 13, acceleration: 13, agility: 13, balance: 13, stamina: 12 } },
    { id: 'medium', team: 'home', pos: { x: 25, y: 34 }, attributes: { pace: 13, acceleration: 13, agility: 13, balance: 13, stamina: 12 } },
    { id: 'long', team: 'home', pos: { x: 20, y: 48 }, attributes: { pace: 13, acceleration: 13, agility: 13, balance: 13, stamina: 12 } },
  ],
  script: [
