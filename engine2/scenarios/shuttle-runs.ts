...
const scenario: ScenarioDef = {
  ...
  bodies: [
    { id: 'mid', team: 'home', pos: { x: 20, y: 28 }, attributes: { pace: 12, acceleration: 12, agility: 12, stamina: 12 } },
    { id: 'elite', team: 'away', pos: { x: 20, y: 40 }, attributes: { pace: 18, acceleration: 16, agility: 14, stamina: 14 } },
  ],
  script: [
