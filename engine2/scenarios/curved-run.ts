...
const scenario: ScenarioDef = {
  ...
  bodies: [
    { id: 'ninety', team: 'home', pos: { x: 15, y: 24 }, attributes: { pace: 15, acceleration: 14, agility: 12, balance: 12, stamina: 12 } },
    { id: 'reverse', team: 'away', pos: { x: 15, y: 46 }, attributes: { pace: 15, acceleration: 14, agility: 12, balance: 12, stamina: 12 } },
  ],
  script: [
