...
import { coveredDuelScenarios, duelScenarios, looseArbitration, matchDuelScenarios, weave } from './duel-1v1.ts';
...
export const SCENARIOS: readonly ScenarioDef[] = [
  ...
  looseArbitration, ...coveredDuelScenarios, ...matchDuelScenarios,
  // L7 — the goalkeeper
  ...keeperScenarios,
];
