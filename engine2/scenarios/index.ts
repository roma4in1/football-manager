...
import { channelDuelScenarios, coveredDuelScenarios, duelScenarios, looseArbitration, matchDuelScenarios, weave } from './duel-1v1.ts';
...
export const SCENARIOS: readonly ScenarioDef[] = [
  ...
  looseArbitration, ...coveredDuelScenarios, ...matchDuelScenarios, ...channelDuelScenarios,
  // L7 — the goalkeeper
  ...keeperScenarios,
];
